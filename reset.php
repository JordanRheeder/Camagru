		...
		<!-- test; -->
			<form action="reset.php" method="post" enctype="multipart/form-data">
						...
						<table align="center" width="750px">
							<tr>
								<td><input placeholder="Enter your e-mail"type="text" name="email" style="margin-left: 309px;" required></td>
							</tr>
					</table>
					<div align="center">
						<tr>
							<td><input class="button is-primary" type="submit" name="reset" value="Reset Account"/></td>
						</tr>
					</div>
			</form>
		</div>
